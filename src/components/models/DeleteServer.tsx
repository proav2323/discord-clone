...
import { useOrigin } from "@/hooks/useOrigin"
 ...
 export const DeleteServerModel = () => {
    ...
    const isModelOpen = isOpen && type === "delete Server"
        ...
        <Dialog open={isModelOpen} onOpenChange={handleClose}>
           <DialogContent className="bg-rose-500 text-white p-0 overflow-hidden">
            <DialogHeader className="pt-8 px-6">
              <DialogTitle className="text-2xl m-2 text-center font-bold">Delete Server</DialogTitle>
              <DialogDescription className="text-center text-white-500" >Are You Sure You Want To Delete <span className="font-semibold text-gray-500">{server?.name}</span> Server</DialogDescription>
            </DialogHeader>
